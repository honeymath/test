...
if __name__ == "__main__":
    ...
    pdf_out = "mainbox_v2.pdf"
    draw_boxes(pdf_in, synctex_in, pdf_out)
    print(f"✅ Boxes drawn to {pdf_out} (first 20 records only)")